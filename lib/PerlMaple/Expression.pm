...
=head1 SYNOPSIS
    ...
    print $expr == 'x^3 + 2*x - 1'; # true
    print $expr != 'x^3 + 2*x - 1'; # false
...
Other operators may be auto-generated by Perl from these.
